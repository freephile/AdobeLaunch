...
namespace MediaWiki\Extension\AdobeLaunch\Tests;

use MediaWiki\Extension\AdobeLaunch\Hooks;

/**
 * @coversDefaultClass \MediaWiki\Extension\AdobeLaunch\Hooks
 */
class HooksTest extends \MediaWikiUnitTestCase {
	...
	public function testOnBeforePageDisplayVandalizeIsTrue() {
		$config = new \HashConfig( [
			'AdobeLaunchVandalizeEachPage' => true
		] );
	...
	public function testOnBeforePageDisplayVandalizeFalse() {
		$config = new \HashConfig( [
			'AdobeLaunchVandalizeEachPage' => false
		] );
		$outputPageMock = $this->getMockBuilder( \OutputPage::class )
			->disableOriginalConstructor()
			->getMock();
